...
[heading__opening_issues]:
  #opening-issues
  "Issues are a great way to show that you care about what S0AndS0 maintains!"


Issues are a great way to show that you care about what S0AndS0 maintains, please search existing issues prior to opening new issues, and utilize the following templates when applicable.
...
[heading__pull_requests]:
  #pull-requests
  "Be a hero to S0AndS0 with quality Pull Requests"


Be a hero to S0AndS0 by making quality Pull Requests with the following templates, or utilize the [General Pull Request][branch__current__template__pull_requests__general] template.


### Bug Fixes
[heading__bug_fixes]:
  #bug-fixes
  "Squish'em good! And tell S0AndS0 all about it"


Squish'em good! And tell S0AndS0 all about it though use of the [Bug Fix][branch__current__template__pull_requests__bug_fix] template.
