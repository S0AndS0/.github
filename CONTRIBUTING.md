...
The text within this document are not _set in stone_ rules but guidelines, and much like other files maintained by S0AndS0 the following may be edited via a _`Pull Request`_.
...
Review the [whole thing][branch__current__code_of_conduct] to see what is expected of those that maintain code with S0AndS0
...
There may be _`orphan`_ branches utilized by S0AndS0 for separating Code to be included in other projects from Documentation and Usage Examples. Non-orphaned development branches are encouraged when adding features or fixing bugs.
...
```
Open Source publishing sense 2013, latest Organizations and commits are considerably less buggy and far more reusable.
...
[branch__current__network_members]:
  network/members
  "Perhaps you too may be counted amount those that have Forked repositories maintain by S0AndS0"

[branch__current__support]:
  SUPPORT.md
  "Best avenues for seeking support of S0AndS0"
...
[badge__issues]: https://img.shields.io/github/issues/S0AndS0/.github.svg

[badge__contributors]: https://img.shields.io/github/forks/S0AndS0/.github.svg?color=005571&label=Contributors
